...
class TaskBoardController extends Controller
{
   ...
   public function getStaffPhoto($id, $project_id) {
    ...
    public function getInviteProjectsData(Request $request){
		...
		$data = DB::table('users')
				->join('project_staff_maps', 'users.id', '=', 'project_staff_maps.staff_id')
				->select('users.id', 'users.role_id', 'users.name', 'users.email',  'users.photo', 'project_staff_maps.project_id', 'project_staff_maps.staff_id', 'project_staff_maps.id', 'project_staff_maps.bActive')
				->where('project_staff_maps.project_id', $project_id)
				->orderBy('users.name', 'asc')
				->get();
    ...
    public function getStaffbyProject(Request $request){
		...
		$data = DB::table('users')
				->select('users.id', 'users.role_id', 'users.name')
