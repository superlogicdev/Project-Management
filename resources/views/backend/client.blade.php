					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="name"><span class="red">*</span> {{ __('Client Name') }}</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="phone"><span class="red">*</span> {{ __('Phone') }}</label>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="country_id"><span class="red">*</span> {{ __('Country') }}</label>
										<select name="country_id" id="country_id" class="chosen-select form-control parsley-validated" data-required="true" tabindex="1">
										</select>
									</div>
								</div>
							</div>
