...
Route::prefix('backend')->group(function(){
	...
	//Client Page
	Route::get('/client', 'Backend\ClientController@getClientPageLoad')->name('backend.client')->middleware(['auth','is_admin']);
	Route::post('/getClientData', 'Backend\ClientController@getClientData')->name('backend.getClientData')->middleware(['auth','is_admin']);
	Route::post('/saveClientData', 'Backend\ClientController@saveClientData')->name('backend.saveClientData')->middleware(['auth','is_admin']);
	Route::post('/getClientById', 'Backend\ClientController@getClientById')->name('backend.getClientById')->middleware(['auth','is_admin']);
	Route::post('/deleteClient', 'Backend\ClientController@deleteClient')->name('backend.deleteClient')->middleware(['auth','is_admin']);
