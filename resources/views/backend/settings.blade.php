					...
					<div class="card-body tabs-area p-0">
						...
						<div class="tabs-body">
							...
							<div id="PurchaseCodeId" class="dnone">
										...
										<div class="row">
											<div class="col-lg-8">
												<div class="form-group">
													...
													<input placeholder="Enter random value" type="text" name="pcode" id="pcode" class="form-control parsley-validated" data-required="true">
								...
								<div class="row mt-15">
									<div class="col-lg-12">
										<p><a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></p>
									</div>
								</div>
							</div>
							<!--/Theme Register-->
